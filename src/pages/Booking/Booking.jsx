...
//   |--------------------------------------------------------------------------
//   |
//   | Backend returns "booked" for both:
//   | - pending
//   | - confirmed
//   |
//   | This extra check also protects the frontend if an older backend
//   | response still returns "pending".
//   |
//   */
...
//     |--------------------------------------------------------------------------
//     |
//     | Any pending/confirmed booking is treated as "booked".
//     | Payment status has nothing to do with availability.
//     |
//     */
...
const Booking = () => {
  ...
  */
  ...
  |--------------------------------------------------------------------------
  | Used to force a fresh API request after a booking conflict/success.
  |--------------------------------------------------------------------------
  */

  const [availabilityRefreshKey, setAvailabilityRefreshKey] =
    useState(0);
  ...
  */
  ...
  |
  | IMPORTANT:
  | Any pending or confirmed booking returned by backend
  | is displayed as "booked".
  |
  | paymentStatus has NO effect here.
  |--------------------------------------------------------------------------
  */
  ...
  const handleSubmit = async (
    ...
    */
    ...
    try {
      ...
      |--------------------------------------------------------------------------
      |
      | The new booking is now pending, and pending means booked.
      | This refresh is useful before navigating away.
      |--------------------------------------------------------------------------
      */
      ...
      <div className="booking-container">
        ...
        <div className="booking-header">
          <div>
            ...
            <p>
              Choose your package,
              event date and guest
              count to submit your
              booking request.
            </p>
          </div>
        </div>
