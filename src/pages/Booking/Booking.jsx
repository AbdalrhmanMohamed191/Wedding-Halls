...
const Booking = () => {
  ...
  */
  ...
  | are all treated as booked.
  |
  | paymentStatus has NO effect on availability.
  |--------------------------------------------------------------------------
  */
  ...
  useEffect(() => {
    ...
    const fetchAvailability = async () => {
      try {
        ...
        |--------------------------------------------------------------------------
        |
        | Any booking that has occupied the date must appear as booked.
        |
        | pending    -> booked
        | confirmed  -> booked
        | completed  -> booked
  ...
  */
  ...
  const availabilityMap = useMemo(() => {
    ...
    availability.forEach((item) => {
      ...
      /*
      |--------------------------------------------------------------------------
      | Booking statuses always become booked
      |--------------------------------------------------------------------------
      */
